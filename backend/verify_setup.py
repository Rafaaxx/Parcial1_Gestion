...
async def verify_repository():
    ...
    try:
        ...
        methods = [method for method, _ in inspect.getmembers(BaseRepository, predicate=inspect.iscoroutinefunction)]
...
async def verify_exceptions():
    ...
    try:
        ...
        assert issubclass(ValidationError, AppException), "ValidationError not subclass of AppException"
