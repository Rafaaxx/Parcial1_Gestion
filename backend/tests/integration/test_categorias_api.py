...
class TestCategoriaIntegration:
    ...
    async def test_update_category_name_success(self, client, admin_token):
        ...
        response = await client.put(f"/api/v1/categorias/{categoria_id}", json=update_payload, headers=headers)
    ...
    async def test_update_category_reparent_success(self, client, admin_token):
        ...
        parent1_resp = await client.post(
            "/api/v1/categorias",
            json={"nombre": "Parent1", "parent_id": None},
            headers=headers
        )
        ...
        parent2_resp = await client.post(
            "/api/v1/categorias",
            json={"nombre": "Parent2", "parent_id": None},
            headers=headers
        )
        ...
        child_resp = await client.post(
            "/api/v1/categorias",
            json={"nombre": "Child", "parent_id": parent1_id},
            headers=headers
        )
    ...
    async def test_delete_category_with_children_returns_409(self, client, admin_token):
        ...
        parent_resp = await client.post(
            "/api/v1/categorias",
            json={"nombre": "Parent", "parent_id": None},
            headers=headers
        )
        parent_id = parent_resp.json()["id"]
