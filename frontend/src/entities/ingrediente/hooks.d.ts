 ...
 */
export declare function useIngredientes(
  skip?: number,
  limit?: number,
  esAlergeno?: boolean
): import('@tanstack/react-query').UseQueryResult<IngredienteListResponse, Error>;
/**
 * Query hook: Fetch a single ingredient by ID
 */
export declare function useIngredienteDetail(
  id: number
): import('@tanstack/react-query').UseQueryResult<IngredienteRead, Error>;
/**
 * Mutation hook: Create a new ingredient
 */
export declare function useCreateIngrediente(): import('@tanstack/react-query').UseMutationResult<
  IngredienteRead,
  Error,
  IngredienteCreate,
  unknown
 ...
 */
export declare function useUpdateIngrediente(
  id: number
 ...
 */
export declare function useDeleteIngrediente(
  id: number
