...
export const Textarea = React.forwardRef(({ className = '', label, error, ...props }, ref) => {
    return (_jsxs("div", { className: "flex flex-col gap-1", children: [label && (_jsx("label", { className: "text-sm font-medium text-gray-700 dark:text-gray-300", children: label })), _jsx("textarea", { ref: ref, className: `
